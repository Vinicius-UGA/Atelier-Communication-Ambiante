(() => {
  ...
  root.innerHTML = `
    <main class="phase2-shell">
      ...
      <section class="phase2-hero phase2-hero-compact">
      ...
      <a class="home-link phase2-bottom-home" href="index.html">← Retour à la page principale<br>pour accéder à la Phase 3</a>
    </main>`;
})();
