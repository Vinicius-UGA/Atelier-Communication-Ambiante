(() => {
  ...
  root.innerHTML = `
    <main class="phase3-shell">
      <div class="phase3-topbar"><a class="home-link" href="index.html">← Accueil</a><div class="eyebrow">Atelier Communication Ambiante · Phase 3</div></div>
      ...
      <section class="section-card phase3-editor-section">
        <div class="phase3-editor-head">
          <div><h2>Votre proposition détaillée</h2><p class="section-intro">Rédigez directement dans le document. Vous pouvez aussi importer des images, les déplacer librement et dessiner à la main sur toute la feuille.</p></div>
          <div class="save-zone"><button id="save-workspace" class="phase3-primary" type="button">Enregistrer le travail</button><span id="save-status" class="save-status">Prêt.</span></div>
        </div>
